...
<head>
  ...
  <title>Head Of Settlement | Dashboard</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Head of Settlement Dashboard</h1>
          </div><!-- /.col -->
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-secondary">
              ...
              <div class="inner">
                ...
                <p>Number of BO A/C holders <br>Per Division</p><!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
...
<script src="../dist/js/pages/dashboard.js"></script>
  ...
  <!-- /.content-wrapper -->
  <footer class="main-footer">
    <strong>Developed and Redesigned by IUB DataCoders 2023.</strong>
    <div class="float-right d-none d-sm-inline-block">
      <b>Version</b> 1.0
    </div>
  </footer>
